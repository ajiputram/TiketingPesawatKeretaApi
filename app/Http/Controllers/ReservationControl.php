...
class ReservationControl extends Controller
{
     ...
     public function simpan(Request $req)
    {
    	$valid = Validator::make($req->all(),[
          ...
          'tempat_duduk'=>'required|between:2,50|unique:reservation,seat_code,null,id,ruteid,'.$req->rute.',depart_at,'.$req->tanggal,
      ...
      if($result){
        ...
        return redirect()->route('reservation.pesan',['id_customer'=>$req->id_customer,'id_type'=>$req->id_type])
